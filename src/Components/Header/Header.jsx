      ...
      <div className={styles.HeaderContainer__navBlock}>
        <div className={styles.HeaderContainer__navBlock__upper}>
          <div className={styles.HeaderContainer__navBlock__upper__buttons}>
            <a target='_blank' href='https://www.vtb.ru/'>Частным лицам</a>
            <a target='_blank' href='https://www.vtb.ru/samozanyatym/'>Самозанятым</a>
            <a target='_blank' href='https://www.vtb.ru/malyj-biznes/'>Малый и средний бизнес</a>
            <a target='_blank' href='#'>Группа ВТБ</a>            
          </div>
          <button>
            <img src='/images/uiimages/dark_switch.png' alt='dark'/>
          </button>
        </div>
        <div className={styles.HeaderContainer__navBlock__bottom}>
          <a target='_blank' href="https://www.vtb.ru/">Банк ВТБ</a>
          <a target='_blank' href="https://www.vtb.ru/about/">Группа ВТБ</a>
          <a target='_blank' href="https://www.vtb.ru/about/press/">Пресс-служба</a>
          <a target='_blank' href="https://www.vtb.ru/about/contacts/">Контакты</a>
          <a target='_blank' href="https://vtbcareer.com/">Вакансии</a>
        </div>
      </div>
    </section>
  );
